...
*   [Lokale Datenspeicherung und iCloud-Sync](#m828)
*   [Bluetooth-Import vom Tauchcomputer](#m2260)
*   [Geschäftliche Leistungen](#m317)
*   [Geschäftsprozesse und -verfahren](#m13)
*   [Einsatz von Online-Plattformen zu Angebots- und Vertriebszwecken](#m605)
*   [Im Rahmen der Geschäftstätigkeit eingesetzte Anbieter und Services](#m3575)
*   [Bereitstellung des Onlineangebots und Webhosting](#m225)
*   [Verarbeitung von Daten im Rahmen von Applikationen (Apps)](#m469)
...
E-Mail-Adresse: [mantadivelog@gmail.com](mailto:mantadivelog@gmail.com)

Impressum: [https://mcshnizzy.github.io/datenschutz](https://mcshnizzy.github.io/datenschutz)
...
„Tauchgangs- und persönliche Daten (Einträge, Notizen, Fotos, Dokumente, etc.) werden ausschließlich lokal auf Ihrem Gerät gespeichert. Ein Abgleich mit Servern findet nur statt, wenn Sie die optionale iCloud-Synchronisierung (Pro-Funktion) aktivieren."

## Bluetooth-Import vom Tauchcomputer

„Beim Import von Tauchgangsdaten über Bluetooth von einem Tauchcomputer wird zur Duplikat-Erkennung ein Kennwert einschließlich der Geräte-Seriennummer dauerhaft auf Ihrem Gerät gespeichert."

**Weitere Hinweise zu Verarbeitungsprozessen, Verfahren und Diensten:**

*   **Bin-Tauchen-Modus (Sperrbildschirm-Anzeige):** „Über den optionalen 'Bin-Tauchen-Modus' können Sie ausgewählte Informationen (Vor- und Nachname, Geburtsdatum, Nationalität, Blutgruppe, Notfallkontakt) auf dem Sperrbildschirm Ihres iPhones anzeigen lassen. Welche Angaben angezeigt werden, legen Sie selbst fest. die Funktion ist standardmäßig deaktiviert. Die Anzeige erfolgt vollständig lokal auf Ihrem Gerät – es findet keine Datenübertragung an Server oder Push-Dienste statt. Bitte beachten Sie: Bei aktivierter Anzeige sind die ausgewählten Informationen für jede Person sichtbar, die das gesperrte Gerät in die Hand nimmt, auch ohne Entsperrung.".
...
*   **Verarbeitete Datenarten:** Bestandsdaten (z. B. der vollständige Name, Wohnadresse, Kontaktinformationen, Kundennummer, etc.); Zahlungsdaten (z. B. Bankverbindungen, Rechnungen, Zahlungshistorie); Kontaktdaten (z. B. Post- und E-Mail-Adressen oder Telefonnummern); Inhaltsdaten (z. B. textliche oder bildliche Nachrichten und Beiträge sowie die sie betreffenden Informationen, wie z. B. Angaben zur Autorenschaft oder Zeitpunkt der Erstellung); Vertragsdaten (z. B. Vertragsgegenstand, Laufzeit, Kundenkategorie); Standortdaten (Angaben zur geografischen Position eines Gerätes oder einer Person); Nutzungsdaten (z. B. Seitenaufrufe und Verweildauer, Klickpfade, Nutzungsintensität und -frequenz, verwendete Gerätetypen und Betriebssysteme, Interaktionen mit Inhalten und Funktionen); Meta-, Kommunikations- und Verfahrensdaten (z. B. IP-Adressen, Zeitangaben, Identifikationsnummern, beteiligte Personen). Bild- und/ oder Videoaufnahmen (z. B. Fotografien oder Videoaufnahmen einer Person).
*   **Betroffene Personen:** Leistungsempfänger und Auftraggeber; Interessenten; Geschäfts- und Vertragspartner; Nutzer (z. B. Webseitenbesucher, Nutzer von Onlinediensten). Kommunikationspartner.
*   **Zwecke der Verarbeitung und berechtigte Interessen:** Erbringung vertraglicher Leistungen und Erfüllung vertraglicher Pflichten; Büro- und Organisationsverfahren; Geschäftsprozesse und betriebswirtschaftliche Verfahren; Bereitstellung unseres Onlineangebotes und Nutzerfreundlichkeit; Kommunikation; Organisations- und Verwaltungsverfahren; Sicherheitsmaßnahmen. Informationstechnische Infrastruktur (Betrieb und Bereitstellung von Informationssystemen und technischen Geräten (Computer, Server etc.)).
*   **Aufbewahrung und Löschung:** Löschung entsprechend Angaben im Abschnitt "Allgemeine Informationen zur Datenspeicherung und Löschung".
*   **Rechtsgrundlagen:** Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO); Einwilligung (Art. 6 Abs. 1 S. 1 lit. a) DSGVO); Vertragserfüllung und vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1 lit. b) DSGVO). Rechtliche Verpflichtung (Art. 6 Abs. 1 S. 1 lit. c) DSGVO).

**Weitere Hinweise zu Verarbeitungsprozessen, Verfahren und Diensten:**

*   **Verarbeitung von Standortdaten:** Im Rahmen der Nutzung unseres Onlineangebots verarbeiten wir die Standortdaten, die entweder vom Gerät der Nutzer erfasst oder von ihnen selbst eingegeben werden. Die Verarbeitung dieser Daten erfolgt auf Grundlage der Einwilligung der Nutzer, welche jederzeit widerrufen werden kann. Die Daten werden ausschließlich genutzt, um die spezifischen Funktionen unseres Onlineangebots bereitzustellen, und entsprechen dabei der Beschreibung, die den Nutzern gegeben wurde, sowie ihrer typischen und erwartbaren Funktionsweise; **Rechtsgrundlagen:** Einwilligung (Art. 6 Abs. 1 S. 1 lit. a) DSGVO).
*   **Apple App Store:** App- und Softwareverkaufsplattform; **Dienstanbieter:** Apple Inc., Infinite Loop, Cupertino, CA 95014, USA; **Rechtsgrundlagen:** Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO); **Website:** [https://www.apple.com/de/app-store/](https://www.apple.com/de/app-store/). **Datenschutzerklärung:** [https://www.apple.com/legal/privacy/de-ww/](https://www.apple.com/legal/privacy/de-ww/).
...
*   **Erhebung von Zugriffsdaten und Logfiles:** Der Zugriff auf unser Onlineangebot wird in Form von sogenannten "Server-Logfiles" protokolliert. Zu den Serverlogfiles können die Adresse und der Name der abgerufenen Webseiten und Dateien, Datum und Uhrzeit des Abrufs, übertragene Datenmengen, Meldung über erfolgreichen Abruf, Browsertyp nebst Version, das Betriebssystem des Nutzers, Referrer URL (die zuvor besuchte Seite) und im Regelfall IP-Adressen und der anfragende Provider gehören. Die Serverlogfiles können zum einen zu Sicherheitszwecken eingesetzt werden, z. B. um eine Überlastung der Server zu vermeiden (insbesondere im Fall von missbräuchlichen Angriffen, sogenannten DDoS-Attacken), und zum anderen, um die Auslastung der Server und ihre Stabilität sicherzustellen; **Rechtsgrundlagen:** Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO). **Löschung von Daten:** Logfile-Informationen werden für die Dauer von maximal 30 Tagen gespeichert und danach gelöscht oder anonymisiert. Daten, deren weitere Aufbewahrung zu Beweiszwecken erforderlich ist, sind bis zur endgültigen Klärung des jeweiligen Vorfalls von der Löschung ausgenommen.
*   **GitHub:** Bereitstellung unserer Website über GitHub Pages, den kostenlosen Website-Hosting-Dienst von GitHub. Beim Abruf unserer Website werden dabei serverseitig Zugriffsdaten in Form von Server-Logfiles verarbeitet, die u. a. die IP-Adresse des Besuchers enthalten können; Rechtsgrundlagen: Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO); **Dienstanbieter:** GitHub B.V., Niederlande, [https://support.github.com/contact/privacy](https://support.github.com/contact/privacy); **Website:** [https://github.com](https://github.com). **Datenschutzerklärung:** [https://docs.github.com/de/site-policy/privacy-policies/github-general-privacy-statement](https://docs.github.com/de/site-policy/privacy-policies/github-general-privacy-statement).
...
Kamerafunktion: Direkte Aufnahme von Fotos zur Dokumentation von Tauchgängen oder Reisen sowie zum Hinzufügen von Profilfotos oder Dokumenten (z. B. Brevets, Zertifikate, Versicherungsnachweise). Die Aufnahmen werden ausschließlich lokal auf dem Gerät des Nutzers gespeichert.

Standortdaten: Zur Angabe des Tauchspots pro Tauchgang kann die Position entweder manuell eingegeben oder einmalig über den GPS-Sensor des Geräts abgefragt werden. Es findet keine fortlaufende Standortverfolgung statt.
...
*   **Kein Standortverlauf und keine Bewegungsprofile:** Die Standortdaten werden lediglich punktuell eingesetzt und nicht zur Bildung eines Standortverlaufs oder eines Bewegungsprofils der verwendeten Geräte, bzw. ihrer Nutzer verarbeitet.
*   **Verarbeitung von Gesundheitsdaten (Bin-Tauchen-Modus):** „Wenn Sie im Rahmen des 'Bin-Tauchen-Modus' Ihre Blutgruppe zur Anzeige auf dem Sperrbildschirm auswählen, verarbeiten wir damit ein Gesundheitsdatum im Sinne von Art. 9 Abs. 1 DSGVO. Diese Verarbeitung erfolgt ausschließlich auf Grundlage Ihrer ausdrücklichen Einwilligung (Art. 9 Abs. 2 lit. a DSGVO), die Sie vor Aktivierung dieser Anzeigeoption gesondert erteilen. Zweck ist die schnelle Verfügbarkeit sicherheitsrelevanter Informationen für Ersthelfer im Notfall. Die Einwilligung können Sie jederzeit mit Wirkung für die Zukunft widerrufen, indem Sie die Anzeige der Blutgruppe in den App-Einstellungen deaktivieren.".
